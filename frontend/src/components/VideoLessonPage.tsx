      ...
      <div className="grid gap-6 lg:grid-cols-[1.65fr_0.95fr]">
        ...
        <div>
          <AnimatePresence mode="wait">
            ...
            {step === "words" && (
              ...
              >
                <CardGlow className="overflow-visible p-6">
                      ...
                      {words.map((word) => {
                        ...
                        return (
                          <motion.div
                            ...
                            className={cn(
                              "group relative overflow-visible rounded-[2rem] border p-5 transition-colors duration-300",
                              reviewed
        ...
        <aside className="space-y-5 lg:sticky lg:top-28">
          <Card className="rounded-[2rem] border-border/60 bg-card/70 p-5 backdrop-blur-xl">
            ...
            {saving && <p className="mt-4 text-xs text-muted-foreground">{t.saving}</p>}
          </Card>
        </aside>
      </div>
    </div>
