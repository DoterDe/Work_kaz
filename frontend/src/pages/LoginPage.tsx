...
import { Sparkles, Mail, Lock, Eye, EyeOff, Brain, Trophy, Zap } from "lucide-react";
  ...
  const copy =
    language === "ru"
      ? {
          ...
          features: [
            { icon: Brain, text: "Синхронизация прогресса между уроками" },
            { icon: Trophy, text: "Быстрый доступ к словарю и квизам" },
            { icon: Zap, text: "Кабинет контент-менеджера" },
          ],
        }
      : {
          ...
          fallbackError: "Кіру мүмкін болмады",
          googleError: "Google арқылы кіру мүмкін болмады",
          noAccount: "Тіркелгі жоқ па?",
          register: "Тіркелу",
          features: [
            { icon: Brain, text: "Сабақтар мен тесттердегі прогресті синхрондау" },
            { icon: Trophy, text: "Сөздікке және квиз тарихына жылдам қолжеткізу" },
            { icon: Zap, text: "Контент студиясына арналған жеке кабинет" },
          ],
        };
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      ...
      >
        ...
        <div className={`grid lg:grid-cols-2 gap-6 overflow-hidden rounded-3xl backdrop-blur-sm shadow-2xl ${bgCard}`}>
          ...
          {/* ПРАВАЯ КОЛОНКА — с закруглёнными углами */}
