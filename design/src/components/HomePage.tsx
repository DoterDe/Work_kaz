...
export function HomePage({ onNavigate }: HomePageProps) {
  const levels = [
    { level: 'A1', title: 'Beginner', description: 'Start your Kazakh journey', icon: BookOpenIcon, lessons: 45 },
    { level: 'A2', title: 'Elementary', description: 'Build your foundation', icon: TargetIcon, lessons: 52 },
    { level: 'B1', title: 'Intermediate', description: 'Expand your skills', icon: TrendingUpIcon, lessons: 48 },
    { level: 'B2', title: 'Upper Intermediate', description: 'Master the language', icon: AwardIcon, lessons: 38 },
  ];
    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          {[
            { step: '01', title: 'Watch Video', description: 'Learn from native speakers', icon: PlayIcon },
            { step: '02', title: 'Learn Words', description: 'Click subtitles for translations', icon: BookOpenIcon },
            { step: '03', title: 'Practice', description: 'Take interactive exercises', icon: TargetIcon },
            { step: '04', title: 'Track Progress', description: 'Monitor your improvement', icon: TrendingUpIcon },
          ].map((item) => {
